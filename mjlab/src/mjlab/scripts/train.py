...
class TrainConfig:
  ...
  """Override the max_iterations from rl_cfg. Useful for quick tests."""

  def __post_init__(self) -> None:
    if self.max_iterations_override is not None:
      object.__setattr__(self.agent, "max_iterations", self.max_iterations_override)
...
def run_train(task_id: str, cfg: TrainConfig, log_dir: Path) -> None:
  ...
  max_iters = cfg.max_iterations_override or cfg.agent.max_iterations
