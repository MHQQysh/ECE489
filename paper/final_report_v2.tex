...
\author{Shihong Yuan (3230116076), Junxiao Wang (3230112131)\\University of Waterloo}
\date{May 14, 2026}
...
\begin{itemize}
    \item Deploy on physical Unitree Go2 robot
    \item Measure sim-to-real gap in tracking and stability
    \item Apply system identification and domain adaptation techniques
    \item Validate robustness claims with real-world disturbances
\end{itemize}
